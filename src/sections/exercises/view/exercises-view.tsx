...
import { ExercisesSortType } from "../exercises-sort-select";
...
export function ExercisesView({ isFavorite = false }: Props) {
  ...
  const variables = useMemo(
    ...
    [keyword, sortBy, pagination.page, categoryId, subCategoryId]
  );
    ...
    <DragDropContext onDragEnd={handleDragEnd}>
      ...
      <Box
        sx={{
          ...
          height: {
            xs: `calc(100svh - ${HEADER.H_MOBILE}px)`,
            md: `calc(100svh - ${HEADER.H_DESKTOP}px)`,
          },
          display: "flex",
          minHeight: 0,
        }}
          ...
          {categoriesLoading ? (
            ...
            <>
              <Box sx={{ flexShrink: 0, minWidth: 0 }}>
                <ExercisesControls
                  categories={categoriesData as Array<Categories>}
                  source={source}
