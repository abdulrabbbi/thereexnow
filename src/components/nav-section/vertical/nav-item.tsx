        ...
        {title && (
          <Box component="span" sx={{ flex: "1 1 auto", minWidth: 0 }}>
            <Box
              ...
              className="label"
              sx={{
                fontSize: subItem ? "14px !important" : "16px !important",
                fontWeight: subItem
                  ? "normal !important"
                  : active
                    ? "bold !important"
                    : "normal !important",
                pl: subItem ? "20px !important" : "0 !important",
                ...(active &&
                  subItem &&
                  !hasChild &&
                  path ===
                    window.location.pathname + window.location.search && {
                    color: "rgb(0, 36, 52) !important",
                    backgroundColor: "rgb(255, 174, 252)",
                    borderRadius: "4px",
                    padding: "2px 8px",
                  }),
                ...(subItem && {
...
const StyledNavItem = styled(ListItemButton, {
  ...
  const baseStyles = {
    ...
    label: {
      ...
      fontWeight:
        theme.typography[
          !active && !subItem ? "fontWeightSemiBold" : "fontWeightMedium"
        ],
    },
    caption: {
      ...noWrapStyles,
